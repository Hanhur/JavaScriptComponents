...
// Task 4
// Давайте напишем функцию f4, которая будет выводить массив a4 в out-4 при нажатии кнопки b-4. Формат вывода - ключ пробел значение +' <br>'. 
...
// Task 6
// Добавьте input .i-61 и i-62. При нажатии b-6 выполняете функцию f6. Функция должна получать из i-61 ключ, а из i-62 значение и добавлять его в массив a6. 
...
// Task 9
// Добавьте input .i-9. При нажатии b-9 выполняете функцию f9. Функция должна вывести в out-9 все ключи массива a9, которые содержат значение, равное значению в input.i-9. 
...
function f9() {
    let searchValue = document.querySelector('.i-9').value;
    let result = '';
    
    let numericValue = isNaN(searchValue) ? searchValue : Number(searchValue);
    
    for (let key in a9) 
    {
        if (a9[key] === numericValue) 
        {
            result += key + ' ';
        }
    }
    
    document.querySelector('.out-9').innerHTML = result.trim();
}

document.querySelector('.b-9').onclick = f9;

// Task 10
// Давайте напишем полезную функцию f10, которая проверяет есть ли значение в ассоциативном массиве. Фукнция должна возвращать true если есть, и false если нет. 
...
function f11() {
    let keyToDelete = document.querySelector('.i-11').value;
    
    if (keyToDelete in a11) 
    {
        delete a11[keyToDelete];
    }
...
// Task 12
//  При нажатии b-12 выполняете функцию f12. Функция должна получить значение из i-12 и удалить запись из массива a12 с таким значением. После этого вывести массив в out-12. 
// Для вывода используйте функцию f5.
...
function f12() {
    let valueToDelete = document.querySelector('.i-12').value;
    
    let numericValue = Number(valueToDelete);
    
    for (let key in a12) 
    {
        if (a12[key] === numericValue) 
        {
            delete a12[key];
        }
    }
...
function f14() {
    ...
    document.querySelector('.out-14').innerHTML = result.trim();
}
...
function f15() {
    ...
    document.querySelector('.out-15').innerHTML = result.trim();
}
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = result.trim();
}
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = result.trim();
}

document.querySelector('.b-17').onclick = f17;

// Task 18
// При нажатии b-18 выполняете функцию f18. Функция должна в out-18 вывести станции метро из массива a18 той ветки, которую пользователь ввел в i-18. 
...
function f18() {
    let line = document.querySelector('.i-18').value.toLowerCase();
    let result = '';
    
    if (a18[line]) 
    {
        result = a18[line].join(' ');
    }
...
function f19() {
    let station = document.querySelector('.i-19').value.trim();
    let result = '';
    
    for (let color in a19) 
    {
        let stations = a19[color];
...
function f20() {
    ...
    document.querySelector('.out-20').innerHTML = result.trim();
}

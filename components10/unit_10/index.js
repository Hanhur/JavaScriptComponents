...
let ar1 = ["Строка", 42, true, "Еще строка", false, 100];
...
let ar2 = ["Строка", 42, true, "Еще строка", false, 100];
...
function f3() {
    out3.textContent = `Длина массива ar3: ${ar3.length - 1}`;
}
...
function f4() {
    const element0 = ar4[0]; 
    const element3 = ar4[3];  
    const element8 = ar4[8];  
            
    out4.textContent = `${element0} ${element3} ${element8}`;
}
...
function f5() {
    const element0 = ar5[0];  
    const element2 = ar5[2];  
    const element3 = ar5[3];  
            
    const sum = element0 + element2 + element3;
...
let ar6 = ["Владимир", "Водолей", 25, 1975];
...
function f10() {
    const firstElement = ar10[1];
            
    const lastIndex = ar10.length - 1;
            
    const lastElement = ar10[lastIndex];
...
function f14() {
    ...
    for (let i = ar14.length - 1; i >= 0; i--) {
        reversedString += ar14[i] + ' ';
    }
            
    out14.textContent = reversedString.trim();
}
...
function f15() {
    ...
    for (let i = 0; i < ar15.length; i++) {
        if (ar15[i] > 0) {
            positiveNumbers += ar15[i] + ' ';
        }
    }
            
    out15.textContent = positiveNumbers.trim();
}
...
let out16__odd = document.querySelector(".out-16-odd");
let out16__even = document.querySelector(".out-16-even");
...
function f16() {
    ...
    out16__odd.textContent = ar16_odd.join(' ');
    out16__even.textContent = ar16_even.join(' ');
}
...
function f20() {
    const sum = ar20.reduce((acc, curr) => acc + curr, 0);
